...
AIP stands for Alpha Improvement Proposal, it has been adapted from the SIP (Synthetix Improvement Proposal). The purpose of this process is to ensure changes to Alpha Finance Lab are transparent and well governed. An AIP is a design document providing information to the Alpha Finance Lab community about a proposed change to the system. The author is responsible for building consensus within the community and documenting dissenting opinions.

## AIP Rationale

We intend AIPs to be the primary mechanisms for proposing new features, collecting community input on an issue, and for documenting the design decisions for changes to Alpha Finance Lab. Because they are maintained as text files in a versioned repository, their revision history is the historical record of the feature proposal.
...
Parties involved in the process are the *author*, the [*AIP editors*](#aip-editors), the Alpha Finance Lab community.

⚠️ Before you begin, vet your idea, this will save you time. Ask the Alpha Finance Lab community first if an idea is original to avoid wasting time on something that will be rejected based on prior research (searching the Internet does not always do the trick). It also helps to make sure the idea is applicable to the entire community and not just the author. Just because an idea sounds good to the author does not mean it will have the intend effect. The appropriate public forum to gauge interest around your AIP is [the Alpha Finance Lab Discord].
...
* **Work in progress (WIP)** -- Once the champion has asked the Alpha Finance Lab community whether an idea has any chance of support, they will write a draft AIP as a [pull request]. Consider including an implementation if this will aid people in studying the AIP.
...
* **Rejected** -- This AIP has failed to reach community consensus.
* **Withdrawn** -- This AIP has has been withdrawn by the author(s).
* **Deferred** -- This AIP is pending another AIP/some other change that should be bundled with it together.
* **Moribund** -- This AIP has been implemented and is now obsolete and requires no explicit replacement.
...
- Motivation (*optional) - The motivation is critical for AIPs that want to change Alpha Finance Lab. It should clearly explain why the existing specification is inadequate to address the problem that the AIP solves. AIP submissions without sufficient motivation may be rejected outright.
...
The AIP editors monitor AIP changes, and correct any structure, grammar, spelling, or markup mistakes we see.

The editors don't pass judgment on AIPs. We merely do the administrative & editorial part.

## History

The AIP document was derived heavily from the SIP Synthetix Improvement Proposal document in many places text was simply copied and modified. Any comments about the AIP document should be directed to the AIP editors.

### Bibliography

[the Alpha Finance Lab Discord]: https://discord.gg/Z2vuKDT
[pull request]: https://github.com/AlphaFinanceLab/AIPS/pulls
